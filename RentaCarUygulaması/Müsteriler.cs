    ...
    public partial class Müsteriler : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO musteriler (ad, soyad, telefon, email, adres, musteriTC) VALUES (@ad, @soyad, @telefon, @email, @adres, @tc)";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "SELECT * FROM musteriler WHERE";
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        int customerID = Convert.ToInt32(dataGridView1.Rows[selectedIndex].Cells["musteriTC"].Value);

                        
                        connection.Open();

                        string query = "DELETE FROM musteriler WHERE musteriTC = @customerID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rowsAffected > 0)
                {
                    MessageBox.Show("Müşteri bilgisi başarıyla güncellendi.");
